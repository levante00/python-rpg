...
Goblin = Monster(
    "Goblin",
    "Goblins are small, weak humanoids with green skin and heigth beetween 3 and 3.5 feet",
    5,
    10,
    3,
    10,
...
Orc = Monster(
    "Orc",
    "Orcs are brutal, violent humanoids with greyish or green skin and animalistic features",
    20,
    40,
    12,
    6,
...
Slime = Monster(
    "Slime",
    "Slimes are gelatinous creatures that can come in many different colors and sizes, the most common appearance is green and about knee height",
    7,
    15,
    5,
    5,
...
Giant = Monster(
    "Giant",
    "Giants are an extraordinarily large humanoid creatures, often with eldritch powers",
    45,
    150,
    30,
    3,
...
Skeleton = Monster(
    "Skeleton",
    "Skeletons are the animated skeletal remains of once-living creatures, used as disposable troops by necromancers",
    10,
    20,
    7,
    6,
...
Vampire = Monster(
    "Vampire",
    "Vampires are undead, nocturnal creatures that subsist on blood, they have superhuman powers and are sometimes able to shape-shift",
    30,
    100,
    25,
    30,
...
Ghoul = Monster(
    "Ghoul",
    "Ghouls are carrion eating undead creatures that dwell in graveyards and other lonely places",
    18,
    30,
    10,
    15,
...
Mummy = Monster(
    "Mummy",
    "Mummies are lumbering undead corpses wrapped in bandages, they are very resiliant to physical damage",
    16,
    35,
    8,
    5,
...
Bear = Monster(
    "Bear",
    "Bears are large heavy mammalsthat have long shaggy hair, rudimentary tails and plantigrade feet",
    12,
    20,
    19,
    10,
