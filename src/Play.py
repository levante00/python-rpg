...
class StartGame:
	...
	def input_map_size(self) -> None:			
		...
		while (self.map_size != 9 and self.map_size != 25 and 
			   self.map_size != 49 and self.map_size != 81): 
	...
	def input_difficulty(self) -> None:
		...
		while self.difficulty != "E" and self.difficulty != "M" and self.difficulty != "H": 
			print(Fore.RED + "Wrong Input, Try Again", Style.RESET_ALL)
			self.difficulty = input("Choose Difficulty[(E)asy, (M)edium, (H)ard]: ").strip()	
	...
	def start_screen(self) -> None:
		...
		print(Fore.RED + START_TEXT.center(os.get_terminal_size().columns), Style.RESET_ALL)
